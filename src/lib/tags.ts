...
const tagReg: Record<string, TagDef> = {
  ...
  view: { label: 'Viewpoint', ink: '#7d641a', bg: '#f4edd8', glyph: '' },
  ...
  logistics: { label: 'Logistics', ink: '#6b604a', bg: '#ece3cf', glyph: '' },
}
...
export const reasonMeta: Record<string, ReasonMeta> = {
  ...
  Feedback: { verb: 'reckons', ink: '#7d641a', bg: '#f4edd8' },
...
export const jKindMeta: Record<string, { label: string; ink: string; bg: string }> = {
  ...
  bag: { label: 'Signature', ink: '#7d641a', bg: '#f4edd8' },
