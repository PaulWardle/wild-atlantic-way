...
export function MapSVG({ geo, maxWidth }: { geo: MapGeometry; maxWidth?: number }) {
  return (
    ...
    >
      ...
      <path d={geo.eLead} fill="none" stroke={c.leadIn} strokeWidth={1.2} strokeDasharray="4 4" strokeLinejoin="round" strokeLinecap="round" />
      <path d={geo.eOff} fill="none" stroke={c.rust} strokeWidth={1.4} strokeLinejoin="round" strokeLinecap="round" />
      {geo.eLiveActive && (
        <path d={geo.eDone} fill="none" stroke={c.greenLine} strokeWidth={1.5} strokeLinejoin="round" strokeLinecap="round" />
      )}
