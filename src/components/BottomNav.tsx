...
export function BottomNav() {
  ...
  return (
    ...
    >
      <Tab label="Home" ink={homeInk} onClick={() => nav({ screen: 'home' })}>
        <svg width={19} height={19} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.7}>
          <circle cx={12} cy={12} r={9} />
          <path d="M12 5 L14.4 12 L12 19 L9.6 12 Z" fill="currentColor" stroke="none" />
        </svg>
      </Tab>
      <Tab label="Days" ink={daysInk} onClick={() => nav({ screen: 'days' })}>
        <svg width={19} height={19} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.7}>
      ...
      <Tab label="Today" ink={todayInk} onClick={() => nav({ screen: 'today' })}>
        <svg width={19} height={19} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.7} strokeLinecap="round" strokeLinejoin="round">
          <circle cx={12} cy={12} r={9} />
          <path d="M12 7.5 V12 L15.5 14" />
        </svg>
      </Tab>
      <Tab label="Journal" ink={journalInk} onClick={() => nav({ screen: 'journal' })}>
      ...
      {isGuest && (
        <Tab label="Postbox" ink={postboxInk} onClick={() => nav({ screen: 'postbox' })}>
      ...
      <Tab label="Info" ink={infoInk} onClick={() => nav({ screen: 'info' })}>
        <svg width={19} height={19} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.7}>
          <circle cx={12} cy={12} r={9} />
