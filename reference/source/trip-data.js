/* Wild Atlantic Way — trip data. Loaded before the DC.
   Isle of Man ridden first (planned elsewhere); here it is only the ferry INTO Ireland
   (Mon 10, Douglas→Larne) and the ferry HOME (Wed 19, Rosslare→Fishguard).
   Stop tags: s=Signature b=Biker road w=WAW point view beach pub cafe food history nature attraction town finish logistics */
window.TRIP = {
  "meta": {
...
if (typeof window !== "undefined") { try { window.dispatchEvent(new Event("trip-ready")); } catch(e){} }
